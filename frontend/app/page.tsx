      ...
      <div className="w-full overflow-x-hidden bg-gray-900">
        <nav className="flex justify-between items-center p-6 bg-black text-white shadow-md">
          <div className="flex items-center">
            <div className="text-2xl font-bold mr-4 text-yellow-300">Logo</div>
        ...
        <section id="aboutus" className="bg-blue-900 text-white py-16">
          <div className="max-w-screen-xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-4">About Us</h2>
            <p className="text-lg text-gray-300">
              We are a team of professionals dedicated to making board
